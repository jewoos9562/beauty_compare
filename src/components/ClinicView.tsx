      ...
      <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200/60">
        ...
        <div className="flex gap-2 mt-3">
          <a
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-50 text-xs font-medium text-slate-600 hover:bg-sky-50 hover:text-sky-700 transition border border-slate-200/60"
          >
